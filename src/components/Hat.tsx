    ...
    >
      ...
      >
        <div className="w-full h-full relative">
          {/* Hat Base */}
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[180px] h-[45px] bg-[#9b87f5] dark:bg-[#33C3F0] rounded-full shadow-lg"></div>
          
          {/* Hat Top */}
          <div className="absolute bottom-[40px] left-1/2 transform -translate-x-1/2 w-[160px] h-[120px] bg-[#1A1F2C] rounded-t-[100px] shadow-inner"></div>
          
          {/* VOI Logo on Hat */}
          <div className="absolute bottom-[80px] left-1/2 transform -translate-x-1/2 text-white font-bold text-center text-xl">
            VOI
          </div>
        </div>
      </motion.div>
